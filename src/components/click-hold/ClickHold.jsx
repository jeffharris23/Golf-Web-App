...
export default class ClickHold extends Component {
   ...
   /* componentDidUpdate(nextState) {
    ...
    render() {
        let classList = this.props.className ? (this.props.className + 'click-hold'):'click-hold';
        classList += this.state.holding ? ' cnh-holding ':'';
        classList += this.state.ended ? ' cnh-ended ':'';
         return (
